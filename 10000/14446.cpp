...
long long solve(int v){
    ...
    while(ind1<=ind2){
        ...
        // break;
        if(ind1%2==1)answer+=arr[ind1].size()-(upper_bound(arr[ind1].begin(),arr[ind1].end(),c)-arr[ind1].begin());
        if(ind2%2==0)answer+=arr[ind1].size()-(upper_bound(arr[ind2].begin(),arr[ind2].end(),c)-arr[ind2].begin());
